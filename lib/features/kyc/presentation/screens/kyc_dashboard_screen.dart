              ...
              Container(
                ...
                child: Center(
                  child: Stack(
                    ...
                    children: [
                      Icon(Icons.fingerprint, size: 64, color: colorScheme.primary.withValues(alpha: 0.4)),
                      Positioned(
                        top: 16,
                        left: 16,
                        child: Icon(Icons.security, color: colorScheme.primary.withValues(alpha: 0.2)),
                      ),
                      Positioned(
                        bottom: 16,
                        right: 16,
                        child: Icon(Icons.verified_user, color: colorScheme.primary.withValues(alpha: 0.2)),
                      ),
                    ],
                  ),
                ),
