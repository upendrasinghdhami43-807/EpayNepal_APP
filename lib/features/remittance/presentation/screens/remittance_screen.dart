...
class _RemittanceScreenState extends State<RemittanceScreen> {
  ...
  static const double _exchangeRate = 132.45;

  double get _sendAmount => double.tryParse(_sendAmountController.text) ?? 0;

  String get _recipientAmount =>
      (_sendAmount * _exchangeRate).toStringAsFixed(2);

  @override
  void initState() {
    super.initState();
    _sendAmountController.addListener(() {
      setState(() {});
    });
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                UiFeedback.comingSoon(context, 'Remittance notifications'),
          ),
        ],
      ),
          ...
          children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              '1 USD = ${_exchangeRate.toStringAsFixed(2)} NPR',
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () =>
                      UiFeedback.comingSoon(context, 'All remittance partners'),
                  child: Text(
                    'View All',
  ...
  Widget _buildPartnerCard(
    ...
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
    final isSelected = _selectedPartnerIndex == partnerIndex;

    return InkWell(
      onTap: () => setState(() => _selectedPartnerIndex = partnerIndex),
      borderRadius: BorderRadius.circular(24),
      child: Container(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Radio<int>(
                  value: partnerIndex,
                  groupValue: _selectedPartnerIndex,
                  onChanged: (val) {
                    if (val == null) return;
                    setState(() => _selectedPartnerIndex = val);
                  },
